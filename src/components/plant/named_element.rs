...
use control_box::plant::{pt1::PT1, TransferTimeDomain, BoxedTransferTimeDomain};
...
impl<S:  Debug + Display + Clone + Copy + PartialEq + 'static + Send + Sync> Default for NamedElement<S> where PT1<f64>: TransferTimeDomain<S> {
    fn default() -> Self {
